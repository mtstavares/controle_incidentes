...
class Config:
    ...
    INTERNAL_API_BASE_URLS = {"pm_cdpm": PM_API_BASE_URL, "netbox": NETBOX_API_BASE_URL}
    INTERNAL_API_TIMEOUTS = {"pm_cdpm": PM_API_TIMEOUT, "netbox": NETBOX_API_TIMEOUT}
    INTERNAL_API_VERIFY_TLS = {"pm_cdpm": PM_API_VERIFY_TLS, "netbox": NETBOX_API_VERIFY_TLS}
    INTERNAL_API_CA_BUNDLES = {"pm_cdpm": PM_API_CA_BUNDLE, "netbox": NETBOX_API_CA_BUNDLE}
